...
GEORGE PACKER
Buras Boat Harbor, in Buras, Louisiana
...
for(i=1; i<=first[1];i++){
    ...
    images = images+"<div id='advt'><a onclick='show("+i+")'><img src='pics/"+first[0]+i+".png'></a><div class='content' id='"+i+"'></div></div>";
}
document.getElementById("grid").innerHTML = images+ "<div id='x' onclick='hide()' >X</div>";
dataArr = data.split("&&&");

for( i=1;i<dataArr.length;i++){
    console.log(document.getElementById(i));
    document.getElementById(i).innerHTML = "<p id='text'>"+dataArr[i]+"</p>";
}
...
function show(i){
    if(window.getComputedStyle(document.getElementById('x')).visibility=="hidden"){
        shown = i;
